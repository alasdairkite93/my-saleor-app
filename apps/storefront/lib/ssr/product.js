  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const channel of regions_1.CHANNELS) {
      ...
      while (hasNextPage) {
        ...
        const edges = (_a = response.data.products) === null || _a === void 0 ? void 0 : _a.edges;
        if (!edges) {
          break;
        }
        ...
        hasNextPage =
          ((_c = (_b = response.data) === null || _b === void 0 ? void 0 : _b.products) === null ||
          _c === void 0
            ? void 0
            : _c.pageInfo.hasNextPage) || false;
        endCursor =
          ((_d = response.data.products) === null || _d === void 0
            ? void 0
...
exports.productPaths = productPaths;
