...
const categoryPaths = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (hasNextPage) {
      ...
      const edges = (_a = response.data.categories) === null || _a === void 0 ? void 0 : _a.edges;
      if (!edges) {
        break;
      }
      ...
      hasNextPage =
        ((_c = (_b = response.data) === null || _b === void 0 ? void 0 : _b.categories) === null ||
        _c === void 0
          ? void 0
          : _c.pageInfo.hasNextPage) || false;
      endCursor =
        ((_d = response.data.categories) === null || _d === void 0
          ? void 0
          : _d.pageInfo.endCursor) || "";
    }
    return paths;
  });
exports.categoryPaths = categoryPaths;
