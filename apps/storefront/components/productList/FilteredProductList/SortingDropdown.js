...
exports.SortingDropdown = void 0;
const react_1 = require("@headlessui/react");
const solid_1 = require("@heroicons/react/solid");
const clsx_1 = __importDefault(require("clsx"));
const react_2 = require("react");
const sorting_1 = require("./sorting");
function SortingDropdown({ optionToggle, chosen }) {
  const options = (0, sorting_1.getSortingOptions)(chosen);
  return (
      ...
      >
        ...
        >
          {options === null || options === void 0
            ? void 0
            : options.map((option) => (
                <react_1.Menu.Item key={option.label}>
                  {({ active }) => (
                    <button
                      type="button"
...
exports.SortingDropdown = SortingDropdown;
exports.default = SortingDropdown;
