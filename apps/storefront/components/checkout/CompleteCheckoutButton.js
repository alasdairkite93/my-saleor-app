...
exports.CompleteCheckoutButton = void 0;
function CompleteCheckoutButton({ isDisabled, isProcessing, children, onClick }) {
  return (
    <>
      {isProcessing ? (
        <button
...
exports.CompleteCheckoutButton = CompleteCheckoutButton;
exports.default = CompleteCheckoutButton;
