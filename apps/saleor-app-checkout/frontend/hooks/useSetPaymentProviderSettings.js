...
exports.useSetPaymentProviderSettings = void 0;
...
const useSetPaymentProviderSettings = (optionalProps) => {
  ...
  const [{ data, loading, error }, request] = (0, useFetch_1.useFetch)(
    fetch_1.requestSetPaymentProviderSettings,
    Object.assign(Object.assign({ skip: true }, optionalProps), {
      args: Object.assign(
        Object.assign(
          {},
...
exports.useSetPaymentProviderSettings = useSetPaymentProviderSettings;
