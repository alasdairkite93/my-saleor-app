...
exports.getOrderTransactions = void 0;
...
const getOrderTransactions = (saleorApiUrl, args) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { data, error: _error } = yield client
      .query(graphql_1.OrderTransactionsDocument, args)
      .toPromise();
    if (
      ((_a = data === null || data === void 0 ? void 0 : data.order) === null || _a === void 0
        ? void 0
        : _a.errors.length) === 0
    ) {
...
exports.getOrderTransactions = getOrderTransactions;
