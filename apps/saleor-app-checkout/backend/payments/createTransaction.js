...
const createTransaction = (saleorApiUrl, args) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { data, error } = yield client
      .mutation(graphql_1.TransactionCreateDocument, args)
      .toPromise();
    console.log(
      (_a = data === null || data === void 0 ? void 0 : data.transactionCreate) === null ||
        _a === void 0
        ? void 0
        : _a.errors,
      error
    ...
    if (
      ((_c =
        (_b = data === null || data === void 0 ? void 0 : data.transactionCreate) === null ||
        _b === void 0
          ? void 0
          : _b.transaction) === null || _c === void 0
        ? void 0
        : _c.id) &&
