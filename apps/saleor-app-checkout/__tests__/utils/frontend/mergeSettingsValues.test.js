...
describe("/utils/frontend/misc/mergeSettingsValues", () => {
  it("overrides default values", () => {
    ...
    const mergedSettings = (0, mapPublicMetafieldsToSettings_1.mergeSettingsValues)(
      defaultSettings,
      savedSettings
    );
    const privateMergedSettings = (0, mapPrivateMetafieldsToSettings_1.mergeSettingsValues)(
      defaultSettings,
  ...
  it("merges sample payment provider values", () => {
    ...
    const mergedSettings = (0, mapPrivateMetafieldsToSettings_1.mergeSettingsValues)(
      defaultSettings,
      savedSettings,
      false
    );
