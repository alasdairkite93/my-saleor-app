...
const parseAndValidateBody = (0, utils_2.createParseAndValidateBody)(
  checkout_common_1.postDropInAdyenSessionsBody
);
const DropInAdyenSessionsHandler = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const { session, clientKey } = yield (0, adyen_1.createAdyenCheckoutSession)(
        saleorApiUrl,
        Object.assign(Object.assign({}, body), { redirectUrl: appUrl })
      );
...
exports.default = (0, utils_1.allowCors)(DropInAdyenSessionsHandler);
